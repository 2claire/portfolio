  ...
  <section>
    ...
    <div class="border-2 w-[250px] h-[450px] lg:w-[450px] rounded-lg">
      ...
      <p class="lg:text-lg px-4 ">
        ...
        My goal is to build meaningful, impactful software that not only meets functional 
        requirements but also delights users with exceptional design and performance.
      </p>
    </div>
    </div>
  <hr/>
